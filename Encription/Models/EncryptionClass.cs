...
namespace Encription.Models
{
    public class EncryptionClass
    {
        ...
        //encryp decrept login student and prof
        /*
         *  select * from Supplementary.ProfessorLogin where ProfessorCode=9004103 
         *  SELECT stcode, [Password] FROM Supplementary.StudentLogin --where stcode='99900999'
